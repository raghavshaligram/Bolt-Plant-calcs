        ...
        <div className="flex flex-col gap-4 p-5">
          ...
          <div className="flex flex-wrap items-start gap-x-6 gap-y-4">
            <div>
              ...
              <div className="mt-1.5 inline-flex flex-wrap gap-1 rounded-lg bg-sand-100 p-1" role="tablist" aria-label="Material">
          ...
          <div>
            ...
            <div className="mt-1.5 inline-flex flex-wrap gap-1 rounded-lg bg-sand-100 p-1" role="tablist" aria-label="Conversion mode">
          ...
          {mode === 'dimensions' && (
            <div className="grid gap-4 sm:grid-cols-3">
              <div>
                ...
                <input id="cy-length" type="number" inputMode="decimal" min="0" step="0.5" value={dimLength} onChange={handleDimLengthChange} className="input-field mt-1.5" />
              </div>
              <div>
                <label htmlFor="cy-width" className="label-field">Width ({lengthUnit})</label>
                <input id="cy-width" type="number" inputMode="decimal" min="0" step="0.5" value={dimWidth} onChange={handleDimWidthChange} className="input-field mt-1.5" />
              </div>
              <div>
                <label htmlFor="cy-depth" className="label-field">Depth ({depthUnit})</label>
                <input id="cy-depth" type="number" inputMode="decimal" min="0" step="0.5" value={dimDepth} onChange={handleDimDepthChange} className="input-field mt-1.5" />
              </div>
            </div>
          )}
            ...
            <div className="flex flex-col gap-4">
              ...
              {weightDirection === 'toVolume' ? (
                <div className="max-w-[10rem]">
                  ...
                  <input id="cy-weight" type="number" inputMode="decimal" min="0" step="0.1" value={weightValue} onChange={handleWeightValueChange} className="input-field mt-1.5" />
                </div>
              ) : (
                <div className="max-w-[10rem]">
                  <label htmlFor="cy-volume" className="label-field">Volume ({volumeUnit})</label>
                  <input id="cy-volume" type="number" inputMode="decimal" min="0" step="0.1" value={volumeValue} onChange={handleVolumeValueChange} className="input-field mt-1.5" />
                </div>
              )}
            </div>
          )}
          ...
          {mode === 'area' && (
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input id="cy-area" type="number" inputMode="decimal" min="0" step="1" value={areaValue} onChange={handleAreaValueChange} className="input-field mt-1.5" />
              </div>
              <div>
                <label htmlFor="cy-area-depth" className="label-field">Depth ({depthUnit})</label>
                <input id="cy-area-depth" type="number" inputMode="decimal" min="0" step="0.5" value={areaDepth} onChange={handleAreaDepthChange} className="input-field mt-1.5" />
              </div>
            </div>
          )}
